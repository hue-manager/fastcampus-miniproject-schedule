...
public interface ScheduleRepository extends JpaRepository<Schedule, Long> {
	...
	List<Schedule> findByUser_IdAndStartDateLessThanEqualAndEndDateGreaterThanEqual(Long userId, LocalDate startDate,
																					LocalDate endDate);
	...
	List<Schedule> findByUser_IdAndStartDateGreaterThanEqualAndEndDateLessThanEqual(Long userId, LocalDate startDate,
																					LocalDate endDate);

	// 시작 날짜가 주어진 범위 내에 있거나 종료 날짜가 주어진 범위 내에 있는 경우 조회
	List<Schedule> findByUser_IdAndStartDateBetweenOrUser_IdAndEndDateBetween(Long userId, LocalDate startYearRange,
																			  LocalDate endYearRange, Long userId2,
																			  LocalDate startYearRange2,
																			  LocalDate endYearRange2);
}
